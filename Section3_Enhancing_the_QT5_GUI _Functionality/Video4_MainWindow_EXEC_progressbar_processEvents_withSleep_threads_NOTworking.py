...
#         self.ui.radioButton_start.clicked.connect(self.start_progressbar)
        self.ui.radioButton_start.clicked.connect(self.start_progressbar_thread)
    ...
    def start_progressbar_thread(self):
        run_thread = Thread(target=self.start_progressbar)
        run_thread.setDaemon(True)
        run_thread.start()
        print(run_thread, run_thread.is_alive())
