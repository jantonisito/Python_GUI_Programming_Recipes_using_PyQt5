'''
This code is the example code for flask_googlemaps from pypi located at: 
https://pypi.python.org/pypi/Flask-GoogleMaps/0.2.5

# NOTE: After starting this server open a browser: http://localhost:5000/fullmap

# OR: Simply enter URL to see the different options: http://localhost:5000/
'''
